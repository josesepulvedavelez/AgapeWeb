...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" 
            SelectCommand="SELECT e.fecha, e.codigo, e.marca, e.modelo, e.serie, e.capacidad, e.tipo, e.localizacion, e.notas, e.prefijo, c.nombre AS cliente FROM equipo AS e INNER JOIN cliente AS c ON e.id_cliente = c.id"></asp:SqlDataSource>
