<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Informe_entrada_resumen.aspx.vb" Inherits="AgapeWeb.Informe_entrada_resumen" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT m.codigo, m.descripcion, m.tipo, SUM(me.cantidad) AS cantidad FROM material AS m INNER JOIN material_entrada AS me ON m.id = me.id_material GROUP BY m.codigo, m.descripcion, m.tipo">
        </asp:SqlDataSource>
        <br />
    </div>
    </form>
