<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Informe_reintegro_resumen.aspx.vb" Inherits="AgapeWeb.Informe_reintegro_resumen" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" SelectCommand="SELECT m.codigo, m.descripcion, m.tipo, SUM(mr.cantidad) AS cantidad 
FROM material AS m INNER JOIN material_reintegro AS mr ON m.id = mr.id_material 
GROUP BY m.codigo, m.descripcion, m.tipo"></asp:SqlDataSource>
