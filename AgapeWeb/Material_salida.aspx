    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPrecio" runat="server" TextMode="Number" required Width="80px"></asp:TextBox>
                </td>
                <td>
                ...
                <td>
                            ...
                            &nbsp;</td>
                <td>
                                <asp:GridView ID="GridView3" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource2" Font-Size="Small" ForeColor="Black">
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" ProviderName="<%$ ConnectionStrings:irmingenieriaConnectionString.ProviderName %>" SelectCommand="SELECT codigo, descripcion, medida, existencia, tipo, notas FROM [material] WHERE ([id] = @id)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlDescripcion" Name="id" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
