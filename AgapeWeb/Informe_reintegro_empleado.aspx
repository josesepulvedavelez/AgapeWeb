<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Informe_reintegro_empleado.aspx.vb" Inherits="AgapeWeb.Informe_reintegro_empleado" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" SelectCommand="SELECT devolucion, fecha, hora, usuario, r.notas, r.id
FROM reintegro r, empleado emp
WHERE emp.id=r.id_empleado and emp.id=@id_empleado
ORDER BY fecha DESC, usuario;">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" SelectCommand="SELECT m.codigo, m.descripcion, mr.cantidad, mr.costo, mr.cantidad * mr.costo AS total 

FROM material AS m INNER JOIN material_reintegro AS mr ON m.id = mr.id_material 

WHERE (mr.id_reintegro = @id_reintegro) ORDER BY m.descripcion">
            <SelectParameters>
                <asp:ControlParameter ControlID="GridView2" Name="id_reintegro" 
                    PropertyName="SelectedValue" />
            </SelectParameters>
        </asp:SqlDataSource>
