<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Informe_salida_resumen.aspx.vb" Inherits="AgapeWeb.Informe_salida_resumen" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" SelectCommand="select m.codigo, m.descripcion, m.tipo, SUM(ms.cantidad) as cantidad
from material as m, material_salida ms
where m.id=ms.id_material
