                    ...
                    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" 
                        ...
                        <Items>
                            ...
                            <asp:MenuItem Text="Mantenimiento" Value="Nuevo elemento">
                                ...
                                <asp:MenuItem Text="Orden Trabajo" Value="Orden Trabajo" 
                                    NavigateUrl="~/Orden_trabajo.aspx"></asp:MenuItem>
                            </asp:MenuItem>
                            ...
                            <asp:MenuItem Text="Informe Mantenimiento" Value="Informe Mantenimiento">
                                <asp:MenuItem Text="Montaje" Value="Montaje" 
                                    NavigateUrl="~/Informe_mantenimiento_montaje.aspx"></asp:MenuItem>
