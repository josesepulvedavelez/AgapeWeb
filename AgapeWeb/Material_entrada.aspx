    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCosto" runat="server" TextMode="Number" required Width="80px"></asp:TextBox>
                    <br />
                </td>
                <td>
                ...
                <td class="auto-style1">
                    <asp:GridView ID="GridView2" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource1" Font-Size="Small" ForeColor="Black">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td class="auto-style1">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:irmingenieriaConnectionString %>" ProviderName="<%$ ConnectionStrings:irmingenieriaConnectionString.ProviderName %>" SelectCommand="SELECT codigo, descripcion, medida, existencia, tipo, notas FROM [material] WHERE ([id] = @id)">
                        <SelectParameters>
